...
namespace Suitsupply.Framework.Core.Persistence
{

    public abstract class Repository<TKey,TEntity>: IRepository<TKey, TEntity> where TEntity : AggregateRoot<TKey, TEntity>
    {
